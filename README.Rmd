...
<!-- badges: start -->
[![Launch Rstudio binder](http://mybinder.org/badge.svg)](https://mybinder.org/v2/gh/softloud/proof/master?urlpath=rstudio)
<!-- badges: end -->
...
Or you can install this compendium as an R package, proof, from GitHub with:
